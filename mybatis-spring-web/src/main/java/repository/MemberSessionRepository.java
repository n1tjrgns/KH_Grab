...
//	
	...
	public Integer updateMemberUpdate(Member member) {
		SqlSession sqlSession = this.getSqlSessionFactory().openSession();
		try {
			String statment = nameSpace+".updateinfoByCondition";
			//System.out.println("member.getmEmail() : " + member.getmEmail() + " member.getmTel() :" + member.getmTel());
	...
	public Integer updateChangePwUpdate(Member member) {
		SqlSession sqlSession = this.getSqlSessionFactory().openSession();
		try {
			String statment = nameSpace+".updateChangePwByCondition";
			//System.out.println("member.getmEmail() : " + member.getmEmail() + "            member.getmPw() :" + member.getmPw());
