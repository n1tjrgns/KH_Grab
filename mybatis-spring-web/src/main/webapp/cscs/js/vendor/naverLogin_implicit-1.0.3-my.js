...
var naver_id_reg = function (client_id,redirect_uri)
{
 ...
 * @private
 */
	this.init_naver_id_reg = function ()
	{
		var naver_id_reg = document.getElementById('naver_id_reg');
		if (naver_id_reg==undefined)
		{
 			return false;
		}
		...
		naver_id_reg.innerHTML="";
		naver_id_reg_contents="";
		naver_id_reg_url = this.getNaverIdLoginLink();
		...
		{
			naver_id_reg_contents="<a href='"+naver_id_reg_url+"' "+naver_id_popup_option+" id='naver_id_reg_anchor'><img src='http://static.nid.naver.com/oauth/button_"+color+".PNG' border='0' title='네이버 아이디로 로그인' width='"+this.button_height+"' height='"+this.button_height+"'></a> ";
		}
		else if (this.button_type == BANNER_SMALL_TYPE)
		{
			naver_id_reg_contents="<a href='"+naver_id_reg_url+"' "+naver_id_popup_option+" id='naver_id_reg_anchor'><img src='http://static.nid.naver.com/oauth/small_"+color+"_in.PNG' border='0' title='네이버 아이디로 로그인' width='"+(this.button_height*656/250)+"px' height='"+this.button_height+"'></a> ";
		}
		else 
		{
			naver_id_reg_contents="<a href='"+naver_id_reg_url+"' "+naver_id_popup_option+" id='naver_id_reg_anchor'><img src='http://static.nid.naver.com/oauth/big_"+color+".PNG' border='0' title='네이버 아이디로 로그인' width='"+(this.button_height*185/40)+"px' height='"+this.button_height+"px'></a> ";
		}
		naver_id_reg.innerHTML=naver_id_reg_contents;
		if (this.is_callback)
		{
			this.init_naver_id_reg_callback();
		}
	}
 ...
 * @private
 */
	this.init_naver_id_reg_callback = function (){
