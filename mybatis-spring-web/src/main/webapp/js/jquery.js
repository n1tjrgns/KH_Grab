!function (a, b) {
    ...
    function (a, b) {
            ...
            var t = function (a) {
                ...
                function db(a, b, d, e) {
                    ...
                    if ((
                        b
                            ? b.ownerDocument || b
                            : t
                    ) !== l && k(b), b = b || l, d = d || [], !a || "string" != typeof a) 
                        return d;
                        ...
                        ? (
                            ...
                            (c.qsa = Y.test(e.querySelectorAll)) && (gb(function (a) {
                                ...
                                a
                                    ...
                                    .length && o.push("name" + K + "*[*^$|!~]?="),
                                a
                                    .querySelectorAll(":enabled")
                                    .length || o.push(":enabled", ":disabled"),
                ...
                d                  = db.selectors = {
                    ...
                    filter      : {
                        ...
                        CLASS : function (a) {
                            var b = w[a + " "];
                            return b || (b = new RegExp("(^|" + K + ")" + a + "(" + K + "|$)")) && w(
                                a,
                                function (a) {
                                    return b.test(
                                        "string" == typeof a.className && a.className || typeof a.getAttribute !== A && a.getAttribute("class") || ""
                                    )
                                }
                            )
                        },
                        PSEUDO: function (a, b) {
                            var c,
                                e = d.pseudos[a] || d.setFilters[a.toLowerCase()] || db.error(
                    ...
                    while (h) {
                        ...
                        for (g in d.filter) 
                            !(e = V[g].exec(h)) || j[g] && !(e = j[g](e)) || (
                                c = e.shift(),
                                f.push({matches: e, type: g, value: c}),
                                h = h.slice(c.length)
                            );
                        if (!c) 
                            break
            ...
            n.extend({
                dir    : function (a, b, c) {
                    var d = [],
                        e = a[b];
                    while (
                        e && 9 !== e.nodeType && (void 0 === c || 1 !== e.nodeType || !n(e).is(c))
                    ) 
        ...
        ab                                               = /^([^.]*)(?:\.(.+)|)$/;
            ...
            n.event                                      = {
                    ...
                    if (r) {
                        ...
                        while (h--) 
                            ...
                            o && (
                                ...
                                (m = g[o]) || (m = g[o] = [], m.delegateCount = 0, j.setup && j.setup.call(a, d, p, k) !== !1 || (
                                    a.addEventListener
                    ...
                    if (r && (k = r.events)) {
                        ...
                        while (j--) 
                            if (
                                ...
                                while (f--) 
                                    g = m[f],
                                    !e && q !== g.origType || c && c.guid !== g.guid || h && !h.test(g.namespace) || d && d !== g.selector && (
                                        "**" !== d || !g.selector
                                    ) || (
                                        m.splice(f, 1),
                ...
                trigger   : function (b, c, d, e) {
                    ...
                    if (
                        h         = l     = d = d || z,
                        3 !== d.nodeType && 8 !== d.nodeType && !_.test(p + n.event.triggered) && (
                    ...
                    ? (
                        a && a.type
                            ? (
                                ...
                                this.type               = a.type,
                                this.isDefaultPrevented = a.defaultPrevented || void 0 === a.defaultPrevented && (a.returnValue === !1 || a.getPreventDefault && a.getPreventDefault())
                                    ? bb
                                    : cb
                            )
                            : this.type = a,
                    ...
                    return Y.test(this.nodeName)
                        ...
                        : void n
                            ...
                            .add(this, "beforeactivate._change", function (a) {
                                var b = a.target;
                                Y.test(b.nodeName) && !n._data(b, "changeBubbles") && (
        ...
        n
            ...
            var fb                                       = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|fo" +
        ...
        sb.th                                            = sb.td;
            ...
            function xb(a, b) {
                return n.nodeName(a, "table") && n.nodeName(
                    ...
                    ? a.getElementsByTagName("tbody")[0] || a.appendChild(
                        ...
                        if (f = a[q], f || 0 === f) 
                            if ("object" === n.type(f)) 
                                ...
                                if (
                                    ...
                                    while (e--) 
                                        n.nodeName(j = f.childNodes[e], "tbody") && !j.childNodes.length && f.removeChild(
                                            j
                                        )
                                }
                        ...
                        if (k && (
                            ...
                            if (f) 
                                for (h = g[g.length - 1].ownerDocument, n.map(g, zb), j = 0; f > j; j++) 
                                    d = g[j],
                                    pb.test(d.type || "") && !n._data(d, "globalEval") && n.contains(h, d) && (
                                        d.src
                    ...
                    text       : function (a) {
                        return W(this, function (a) {
                            return void 0 === a
                                ...
                                : this
                                    .empty()
                                    .append((this[0] && this[0].ownerDocument || z).createTextNode(a))
                        }, null, a, arguments.length)
                    }
                }),
        n.each({
        ...
        Eb                                               = {};
            ...
            function Gb(a) {
                ...
                return c || (
                    c     = Fb(a, b),
                    "none" !== c && c || (
                        Db = (Db || n("<iframe frameborder='0' width='0' height='0'/>")).appendTo(b.documentElement),
            ...
            !function () {
                var a,
                    ...
                    d = "-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-" +
        ...
        Lb                                               = /^(top|right|bottom|left)$/;
            ...
            !function () {
                var b,
                    ...
                    j = "-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-" +
                            "box;display:block;padding:0;margin:0;border:0";
                ...
                function k() {
                    ...
                    h && (
                        ...
                        c.style.cssText = "-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box" +
        ...
        l.opacity || (n.cssHooks.opacity = {
                ...
                set: function (a, b) {
                    ...
                    c.zoom = 1,
                    (b >= 1 || "" === b) && "" === n.trim(f.replace(Nb, "")) && c.removeAttribute && (
        ...
        $b.propHooks                                     = {
                _default: {
                    get: function (a) {
                        var b;
                        return null == a.elem[a.prop] || a.elem.style && null != a
                            .elem
                            .style[a.prop]
                                ? (
        ...
        attr      : function (a, b, c) {
            ...
            if (a && 3 !== f && 8 !== f && 2 !== f) 
                return typeof a.getAttribute === L
                    ? n.prop(a, b, c)
                    : (
                        1 === f && n.isXMLDoc(a) || (b = b.toLowerCase(), d = n.attrHooks[b] || (
    ...
    n.fn.extend(
        ...
        n.parseJSON = function (b) {
            ...
            return c && c.documentElement && !c
                .getElementsByTagName("parsererror")
                .length || n.error("Invalid XML: " + b),
            c
        };
        ...
        n.extend({
            ...
            ajax         : function (a, b) {
                ...
                if (
                    ...
                    null == k.crossDomain && (
                        ...
                        k.crossDomain = !(!c || c[1] === zc[1] && c[2] === zc[2] && (c[3] || (
                            "http:" === c[1]
                                ? "80"
                                : "443"
                        )) === (zc[3] || (
                ...
                if (k.beforeSend && (k.beforeSend.call(l, v, k) === !1 || 2 === t)) 
                    return v.abort();
                u            = "abort";
                for (d in {complete: 1, error: 1, success: 1}) 
                    v[d](k[d]);
                if (i = Nc(Jc, k, b, v)) {
                    v.readyState = 1,
            ...
            n[b] = function (a, c, d, e) {
                ...
                n.ajax({data: c, dataType: e, success: d, type: b, url: a})
            }
        }), n.each([
            "ajaxStart",
            "ajaxStop",
            ...
            return a.offsetWidth <= 0 && a.offsetHeight <= 0 || !l.reliableHiddenOffsets() && "none" === (
        ...
        return d
            ...
            serializeArray: function () {
                return this
                    ...
                    .filter(function () {
                        var a = this.type;
                        return this.name && !n(this).is(":disabled") && Vc.test(this.nodeName) && !Uc.test(
                            a
        ...
        n.fn.load = function (a, b, c) {
            ...
            g.length > 0 && n
                .ajax({data: b, dataType: "html", type: f, url: a})
                .done(function (a) {
                    e = arguments,
                    g.html(
                        d
